...
contract AinToken is Ownable { //ERC - 20 token contract
  ...
  string public constant name = "Adult Intro Network";
  uint8 public constant decimals = 8;
  uint256 _totalSupply = (uint)(250000000).mul((uint)(10).pow(decimals));
